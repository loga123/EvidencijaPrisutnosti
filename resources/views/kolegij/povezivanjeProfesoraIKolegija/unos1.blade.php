...
<div class="col-lg-6 col-lg-offset-3" style="margin-top: 50px;">
   ...
   {!!  Form::open(['action' => 'KolegijController@store1']) !!}
    ...
    <div class="row" style="margin-left: 4%">
        ...
        <div class="col-md-9">
            ...
            <h2 class="text-center">Dobrodošli u sučelje za povezivanje nositelja s kolegijem</h2>
    ...
    <div class="row" style="margin-left: 4%">
        ...
        <div class="col-md-9">
            ...
            {!! Form::submit('Unesi nositelja za kolegij', ['class' => 'btn btn-primary form-control'] ) !!}
