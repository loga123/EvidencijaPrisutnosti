    ...
    <div class="row">
        ...
        <div class="col-md-4 col-md-offset-2" style="margin-top: 50px;">
            ...
            <div class="row">
                ...
                <h3 class="text-center">Pregled razina prava</h3>
                ...
                <table class="table table-striped table-bordered table-hover ">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>{{ $i }}</td>
                            <td>{{ $razina->opis }}</td>
                            <td><a href="{{url('admin/razina-prava',$razina->sifra_razine)}}" class="btn btn-primary">Prikaz</a></td>
                            <td><a href="{{url('admin/razina-prava/'.$razina->sifra_razine).'/edit'}}" class="btn btn-warning">Uređivanje</a></td>
                            <td>

                                {!! Form::open(['method' => 'DELETE','action' => ['RazinaPravaController@destroy', $razina->sifra_razine]]) !!}

                                {{ Form::button('Obrišite ', ['type' => 'button', 'class' => 'btn btn-danger btn-delete',' data-toggle'=>'modal','data-target'=>'#confirmDelete'.$brojac.'','data-title'=>'Brisanje razine prava','data-message'=>'Da li ste sigurni da želite obrisati razinu: '.$razina->opis.''] )  }}
